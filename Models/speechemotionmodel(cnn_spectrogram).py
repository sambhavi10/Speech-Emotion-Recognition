# -*- coding: utf-8 -*-
"""SpeechEmotionModel(CNN Spectrogram).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HjjfzOaEVM6UV-x40mlcaM93J19e_QaP
"""
...
data_dir = 'drive/MyDrive/SpectrogramTrainTest/Train'
batch_size = 32
img_height = 180
img_width = 180
...
test_data_generator = test_generator.flow_from_directory(
    'drive/MyDrive/SpectrogramTrainTest/Test', # Put your path here
...
CNN_Spec_df = pd.DataFrame(predicted_classes)

CNN_Spec_df

CNN_Spec_df.to_csv("CNN_Spec_df.csv")
...
ax.set_title('CNN Using Spectrogram Images\n\n');
ax.set_xlabel('\nPredicted Values')
